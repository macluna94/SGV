...
(function ($) {
    ...
    $.fn.fileinputLocales['es'] = {
        ...
        msgPlaceholder: 'Selectcione {files}...',
        msgZoomModalHeading: 'Vista previa detallada',
        msgFileRequired: 'Debe subir un archivo para continuar.',
        msgSizeTooSmall: 'El archivo "{name}" (<b>{size} KB</b>) es demasiado pequeño y debe ser mayor de <b>{minSize} KB</b>.',
        msgSizeTooLarge: 'El archivo "{name}" excede el tamaño máximo permitido de <b> 5 MB </b>.',
        ...
        msgInvalidFileExtension: 'Extensión de archivo no válido para "{name}". Sólo se permiten archivos <b>"{extensions}"</b>.',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
